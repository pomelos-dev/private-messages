...
const CONNOR_PROFILE = {
  ...
  posts: [
    ...
    { id: 'cs_0', image: 'connorHudsonSunset', caption: 'He matches my enthusiasm ♒️♓️✨', comments: [
      ...
      { username: 'hudconstrong', text: 'the way hudson liked this 10s after it was posted 👀' },
      { username: 'hudcel9113', text: 'leave him alone connor. the show ended years ago' },
      { username: 'merryhudconmas', text: 'we never lose. that\'s all I\'m saying' },
      { username: 'gizmoforlife', text: 'hudson is straight btw. y\'all are so embarrassing' },
      { username: 'wingedfane', text: 'The way you unhinged truthers are ignoring the fact that your fave was found in a gay bar 12 hours ago' },
      { username: 'mediumhud', text: 'stop using hudson for clout. go play with your new costar' },
      { username: 'chantalg', text: 'they\'re friends. people are allowed to have friends.' },
    ] },
...
const makeHudsonProfile = (connorComment) => ({
  ...
  posts: [
    ...
    { id: 'hw_1', image: 'hudsonIg1', caption: 'Sometimes it feels like we exist in two different worlds', comments: [
      { username: 'hudcel9113', text: 'you people are making it weird as always' },
      { username: 'connorie', text: 'hudson is taken and he isn\'t even connor\'s type. move on.' },
      { username: 'chantalg', text: 'it\'s a caption not a confession. the parasocial behaviour in this fandom is unreal.' },
      { username: 'mediumhud', text: 'two different worlds... as in one has a girlfriend and the other one needs to back off?' },
      { username: 'annabelly', text: 'he\'s been posting like this for weeks. someone who loves him please intervene' },
      { username: 'hudconstrong', text: 'guys please keep it out of the comments where he can see' },
    ] },
