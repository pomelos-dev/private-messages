...
const scriptA_good = [
  ...
  { type: 'their', from: 'hudson', text: 'I came here thinking I was ready for something and now I\'m not so sure' },
  { type: 'their', from: 'hudson', text: 'And being around you makes it really hard to figure things out' },
  ...
  { type: 'their', from: 'hudson', text: 'I just don\'t trust myself around you right now' },
  { type: 'choice', options: [
    { text: 'Are you sure?' },
    { text: 'For how long?' },
    { text: 'Hudson...' },
  ...
  { type: 'their', from: 'hudson', text: 'I\'ll think of something when it\'s calmer' },
...
const scriptB_good = [
  ...
  { type: 'their', from: 'hudson', text: 'It\'s OK' },
  { type: 'their', from: 'hudson', text: 'But...' },
  { type: 'their', from: 'hudson', text: 'I keep reading into things and it\'s making me crazy' },
  { type: 'their', from: 'hudson', text: 'I came here thinking I was ready for something and now I\'m not so sure' },
  { type: 'their', from: 'hudson', text: 'And being around you makes it really hard to figure things out' },
  { type: 'their', from: 'hudson', text: 'I think we need to go quiet for a bit' },
  { type: 'their', from: 'hudson', text: 'Actually quiet' },
...
const scriptB_ok = [
  ...
  { type: 'their', from: 'hudson', text: 'But...' },
  { type: 'their', from: 'hudson', text: 'All those people speculating' },
  { type: 'their', from: 'hudson', text: 'It\'s messing with my head. Making me second-guess everything' },
  { type: 'their', from: 'hudson', text: 'I think we need to go quiet for a bit' },
  { type: 'their', from: 'hudson', text: 'Actually quiet' },
  { type: 'choice', options: [
    { text: 'What do you mean?' },
  ...
  { type: 'their', from: 'hudson', text: 'I\'m going to go home for a bit' },
  { type: 'their', from: 'hudson', text: 'And I think I need to not talk to you for a while, too' },
  { type: 'their', from: 'hudson', text: 'I keep reading into things and I need to stop doing that' },
  { type: 'their', from: 'hudson', text: 'I know it\'s just for promo, but I didn\'t expect it to feel so shitty' },
  { type: 'choice', options: [
    { text: 'I\'m sorry. I\'ll miss you.' },
...
const scriptC_good = [
  ...
  { type: 'their', from: 'hudson', text: 'It\'s OK' },
  { type: 'their', from: 'hudson', text: 'But...' },
  { type: 'their', from: 'hudson', text: 'All those people speculating, it\'s messing with my head' },
  { type: 'their', from: 'hudson', text: 'I came here thinking I was ready for something and now I\'m not so sure' },
  { type: 'their', from: 'hudson', text: 'And being around you makes it really hard to figure things out' },
  { type: 'their', from: 'hudson', text: 'I think we need to go quiet for a bit' },
  { type: 'their', from: 'hudson', text: 'Actually quiet' },
  ...
  { type: 'their', from: 'hudson', text: 'I\'m going to fly home tonight' },
  { type: 'their', from: 'hudson', text: 'And I think I need to not talk to you for a while, too' },
  { type: 'their', from: 'hudson', text: 'Clear my head' },
  { type: 'their', from: 'hudson', text: 'You\'ve got Ascension to focus on' },
  { type: 'their', from: 'hudson', text: 'I don\'t want to be another thing you\'re managing right now' },
  { type: 'choice', options: [
    { text: 'Are you sure?' },
...
const scriptC_ok = [
  ...
  { type: 'their', from: 'hudson', text: 'And maybe it\'s selfish, but I\'m glad you didn\'t go through with it' },
  ...
  { type: 'their', from: 'hudson', text: 'I\'ll think of something when things are calmer' },
  { type: 'their', from: 'hudson', text: 'I\'ll miss you too, obviously' },
  { type: 'their', from: 'hudson', text: 'That\'s kind of the problem' },
  ...okFarewell,
];
