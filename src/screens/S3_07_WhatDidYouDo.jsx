 ...
 * All GOOD/OK paths → slow transition "Six months later…" → S3_08.
 */

// ── Shared closings (all three branches use these) ─────────────────
...
const closingGood = [
  ...
  { type: 'their', from: 'hudson', text: 'I can\'t think straight otherwise' },
  ...
  { type: 'their', from: 'hudson', text: 'I don\'t know' },
  ...
  { type: 'wait', ms: 2500 },
  { type: 'transition', text: 'Six months later…', to: 'S3_08', slow: true },
];
...
const closingOk = [
  ...
  { type: 'their', from: 'hudson', text: 'And I think we need to go quiet for a bit' },
  { type: 'their', from: 'hudson', text: 'Actually quiet' },
  { type: 'choice', options: [
...
const scriptA_bad = [
  { type: 'their', from: 'hudson', text: 'Yeah' },
  { type: 'their', from: 'hudson', text: 'Maybe not' },
  { type: 'wait', ms: 2500 },
  {
    type: 'gameover',
    animate: 'bad',
    message: 'You evaded the issue. Hudson flies home without saying goodbye.',
    retryScreen: 'S3_07_A',
    restartScreen: 'S3_01',
...
const scriptA = [
  ...
  { type: 'their', from: 'hudson', text: 'I just didn\'t expect it to feel like this' },
  ...
  { type: 'choice', options: [
    ...
    { text: 'I didn\'t mean it to sound like that.' },
  ]},
  ...
  { type: 'choice', options: [
    { text: 'Hudson, you know I didn\'t mean it that way.',        extend: scriptA_good },
    { text: 'We both knew there was no good way to handle this.', extend: scriptA_bad  },
    { text: 'I should have run it by you first.',                 extend: scriptA_ok   },
  ]},
];
...
const scriptB_bad = [
  ...
  { type: 'wait', ms: 2500 },
  {
    type: 'gameover',
    animate: 'bad',
    message: 'You made it about his decision. Hudson needed you to talk about yours. He flies home without saying goodbye.',
    retryScreen: 'S3_07_B',
    restartScreen: 'S3_01',
    restartLabel: 'Restart Chapter 3',
  },
...
const scriptB = [
  ...
  { type: 'choice', options: [
    { text: 'Going to Hi Tops was a mistake. I had to regain control of the narrative.', extend: scriptB_bad  },
...
const scriptC = [
  ...
  { type: 'choice', options: [
    ...
    { text: 'It just didn\'t feel right.',                                                        extend: closingOk   },
