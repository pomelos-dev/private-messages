...
const romanticB = [ // Connor directs Hudson
  ...
  { type: 'their', from: 'hudson', text: 'Director Connor knows what he wants' },
  { type: 'their', from: 'hudson', text: 'In public... and in private' },
  { type: 'auto', text: 'Good.' },
  ...
  { type: 'their', from: 'hudson', text: 'Stop distracting me!' },
  { type: 'their', from: 'hudson', text: 'I\'m trying to remember my lines' },
  { type: 'auto', text: 'You love it.' },
  { type: 'their', from: 'hudson', text: 'I really do' },
  { type: 'their', from: 'hudson', text: '❤️' },
  { type: 'wait', ms: 6000 },
  { type: 'chapter_complete', title: 'Private Messages: The End', message: 'We finally gave it a name.\nThis is the real us. ❤️' },
];
